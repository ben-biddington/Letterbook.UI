...
The network tab in the browser shows the endpoints required to load the UI elements, for example:

```
http://localhost:9999/api/v1/timelines/home
```

## Decision

### Implement `home` to see how hard it is

There is a reference [here](https://docs.joinmastodon.org/methods/timelines/#home).

It returns an array of [status](https://docs.joinmastodon.org/entities/Status/#example):
